...
void main() {
  ...
  setUp(() {
    ...
    mockClientsRepository =
        MockClientsRepository(client: mockClient, shouldFail: true);
  });

  blocTest(
    'Should emit LinkDeviceState with status [LinkDeviceStatus.failure] when linkDevice is called unsuccessfully',
