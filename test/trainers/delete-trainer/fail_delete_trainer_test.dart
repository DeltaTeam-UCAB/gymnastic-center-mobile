...
void main() {
  ...
  setUp(() {
    ...
    mockTrainerRepository = MockTrainerRepository(mockTrainers, shouldFail: true);
  });

  blocTest(
      'Should emit DeleteTrainerState with status deleting and error when deleteTrainer is called',
      ...
      expect: () => [
        ...
        isA<DeleteTrainerState>()
          .having((state) => state.status, 'status', DeleteTrainerStatus.error),
      ]);
}
