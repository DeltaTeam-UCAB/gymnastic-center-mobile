...
void main() {
  ...
  setUp(() {
    ...
    mockTrainerRepository = MockTrainerRepository(mockTrainer, false);
  });

  blocTest(
    'Should emit TrainerState with isFollowing false when ToggleFollow is called',
    ...
    expect: () => [
      ...
      isA<TrainerState>()
          ...
          .having((state) => state.trainer.followers, 'followers', 99),
    ],
  );
}
