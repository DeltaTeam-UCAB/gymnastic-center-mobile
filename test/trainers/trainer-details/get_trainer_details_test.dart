...
void main() {
  ...
  setUp(() {
    ...
    mockTrainerDetails = TrainerDetails(trainer: mockTrainer, isFollowing: false, blogCount: 10, courseCount: 10);
  ...
  blocTest(
    ...
    expect: () => [
      ...
      TrainerDetailsState(isLoading: false, trainer: mockTrainer, blogCount: 10, courseCount: 10, isFollowing: false),
    ],
  );
}
