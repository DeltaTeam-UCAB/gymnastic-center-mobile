...
void main() {
  ...
  setUp(() {
    ...
    mockTrainerRepository =
        MockTrainerRepository([mockTrainerDetails], isFollowing: false);
  });

  blocTest(
    'Should emit FollowTrainerState with state [FollowTrainerStatus.success] when toggleFollow is called',
    ...
    expect: () => [
      ...
      const FollowTrainerState(status: FollowTrainerStatus.success),
    ],
  );
}
