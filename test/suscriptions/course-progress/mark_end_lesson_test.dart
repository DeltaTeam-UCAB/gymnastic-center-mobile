...
void main() {
  ...
  blocTest(
      'Should emit CourseProgressBlocState with 25% course percent and 50% firsst lesson percent when markEndLesson is called',
      ...
      act: (bloc)  {
        bloc.markEndLesson('1', '1', 120, 60);
      },
      expect: () => [
        isA<CourseProgressState>()
          .having((state) => state.coursePercent, 'coursePercent', 25)
          .having((state) => state.lessonsProgress[0].percent, 'lessonsProgress percent', 50)
