...
void main() {
  ...
  setUp(() {
    ...
    mockCoursesRepository = MockCoursesRepository(mockCourses, true);
  });

  blocTest(
      'Should emit DeleteCourseState with staatus deleting and error when deleteCourse is called',
      ...
      expect: () => [
        ...
        isA<DeleteCourseState>()
          .having((state) => state.status, 'status', DeleteCourseStatus.error),
      ]);
}
