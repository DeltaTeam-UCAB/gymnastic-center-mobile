...
class CoursesDatasourceImpl extends CourseDatasource {
  ...
  final dio = Dio( BaseOptions(
    ...
    headers: {
      'auth' : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjkzNWQ1MWMzLWViYzgtNDQyNy1hZDg3LTllZTY2OWNmNWU3OSIsImlhdCI6MTcxNDk1MDQ3OH0.GD_6noVQuag3jm_2t-kkqqTNX-6qytwT1jrJpJbngMw'
      } 
    )
  );

  @override
  Future<List<Course>> getCoursesPaginated({int limit = 5, int offset = 0}) async {
    final response = await dio.get('/course/paginated?limit=$limit&offset=$offset');
